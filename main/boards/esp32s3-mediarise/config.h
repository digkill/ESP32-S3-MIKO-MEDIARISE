...
// ESP32S3-MediaRise configuration
// Плата для создания робота на базе ESP32-S3
...
// Определения выводов для определения уровня заряда батареи
#define BATTERY_ADC_PIN         GPIO_NUM_1  // ADC вывод для определения напряжения батареи
#define BATTERY_CHARGING_PIN    GPIO_NUM_41 // Вывод для определения состояния зарядки

// UART для управления сервоприводами (связь с мастер-контроллером)
