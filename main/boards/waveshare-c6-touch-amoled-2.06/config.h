...
/*
 * External XIAO ESP32-S3 camera/servo/LED/proximity bridge.
 * GPIO14/GPIO15 are unused by the C6 display, codec, boot button and USB console.
 */
#define XIAO_UART_PORT_NUM       UART_NUM_1
#define XIAO_UART_TX_PIN         GPIO_NUM_14
#define XIAO_UART_RX_PIN         GPIO_NUM_15
